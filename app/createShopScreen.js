  ...
  const handleCreateShop = async () => {
    ...
    try {
      ...
      if (bearerToken) {
        ...
        const createShopApiEndpoint = 'https://dzo.onrender.com/api/vi/shop/owner/new/shop';
  ...
  return (
    <ScrollView style={{ flexDirection: "column", flex: 1  }}>
      ...
      <TextInput
        ...
        onChangeText={(text) =>
            setShopData({ ...shopData, shopType: text })
          }
      />
      ...
      <TextInput
        ...
        onChangeText={(text) =>
            setShopData({ ...shopData, latitude: text })
          }
      ...
      <TextInput
        ...
        onChangeText={(text) =>
            setShopData({ ...shopData, longitude: text })
          }
        keyboardType="numeric"
      />
